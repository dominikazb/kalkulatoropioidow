...
export const OPIOIDS: Opioid[] = [
  ...
  new Opioid(8, 'Morfina (s.c., i.v., i.m.)', 0, 2, 2, 0),
  new Opioid(9, 'Morfina (tbl. doustne)', 0, 1, 1, 0),
  new Opioid(10, 'Oksykodon, chlorowodorek (tbl. doustne, i.v., s.c.)', 0, 2, 2, 0),
  new Opioid(11, 'Tapentadol', 0, 0.3, 0.4, 0),
  new Opioid(12, 'Tramadol (s.c. lub i.v.)', 0, 0.1, 0.1, 0),
  new Opioid(13, 'Tramadol (tbl. doustne lub krople)', 0, 0.1, 0.2, 0)
];
